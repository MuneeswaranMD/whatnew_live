  ...
  return (
    ...
    >
      <Box sx={{ width: '100%', maxWidth: 1200 }}>
        <Grid container spacing={3} justifyContent="center">
          <Grid item xs={12} md={8}>
            <Card sx={{ mb: 3 }}>
              <CardHeader
                title={
                  <Typography variant="h5" sx={{ color: iosColors.primary, fontWeight: 700, textAlign: 'center' }}>
                    <MonetizationOn sx={{ mr: 1, verticalAlign: 'middle' }} />
                    Credits Management
                  </Typography>
                }
                subheader={<Typography sx={{ textAlign: 'center' }}>Manage your livestream credits and track usage</Typography>}
                  ...
                  <Grid item xs={12} md={6}>
                    <Card variant="outlined" sx={{ mb: 2 }}>
                      <CardHeader
                        ...
                        title={<Typography sx={{ textAlign: 'center' }}>How Credits Work</Typography>}
                        sx={{ pb: 0 }}
                      />
                      <CardContent>
                        <Stack spacing={1}>
                ...
                {isFirstPurchase && (
                  <>
                    <Alert
                      ...
                      sx={{ mb: 2, mx: 'auto', maxWidth: 600 }}
                    />
                    <Typography variant="subtitle1" color="warning.main" fontWeight={700} mb={2} sx={{ textAlign: 'center' }}>
                      <Star sx={{ mr: 1 }} />
                    ...
                    <Typography variant="subtitle1" color="secondary" fontWeight={700} mb={2} sx={{ textAlign: 'center' }}>
                      <GridOn sx={{ mr: 1 }} />
                      Regular Plans
                    </Typography>
                  </>
                    ...
                    <Grid item xs={12} sm={6} md={4} key={pkg.credits}>
                      ...
                      >
                        <CardContent sx={{ textAlign: 'center' }}>
                          ...
                          <Typography variant="h4" color="black" fontWeight={700}>{pkg.credits} <small className='text-black'>Credits</small></Typography>
                          <Typography variant="h5" color="success.main">₹{pkg.price}</Typography>
                          {pkg.original_price > pkg.price && (
                            <Typography variant="body2" color="text.secondary" sx={{ textDecoration: 'line-through' }}>
                              ₹{pkg.original_price}
              ...
              <CardContent>
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (!showUsageHistory) fetchUsageHistory();
                  }}
                  sx={{ mb: 2, mx: 'auto', display: 'block' }}
                >
                  {showUsageHistory ? "Hide Usage History" : "Show Usage History"}
                </Button>
                {showUsageHistory && (
                  <Box>
                    {loadingUsage ? (
        ...
        {/* Transaction History */}
        <Card sx={{ mt: 3, mx: 'auto', maxWidth: 1200 }}>
          <CardHeader
            title={
              <Stack direction="row" alignItems="center" spacing={1} justifyContent="center">
                <Assignment />
